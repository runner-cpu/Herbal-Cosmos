...
首页还承担“数字博物馆入口”职责：首屏之后依次呈现馆藏规模看板、功效分类速览、六个主题入口、精选本草图鉴、典籍时光和项目数据来源。这样内容较少的药食同源、文化与非遗等模块先在首页提供可视化预览，再进入独立页面进行完整浏览。
...
| 学习舱 | 知识卡复习、互动测验与本机学习进度 | 进度轨迹 + 选择题 |
...
| 全量名称索引 | 2,275 条可检索名称（2,283 条原始索引经噪声清洗） | 搜索、来源筛选、分页；仅名称，不伪造药性字段 | 轻量表格 |
